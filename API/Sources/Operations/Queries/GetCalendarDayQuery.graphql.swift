...
public class GetCalendarDayQuery: GraphQLQuery {
  ...
  public struct Data: API.SelectionSet {
    ...
    public struct Calendar: API.SelectionSet {
      ...
      public static var __parentType: ApolloAPI.ParentType { API.Objects.Calendar }
      public static var __selections: [ApolloAPI.Selection] { [
      ...
      public struct Day: API.SelectionSet {
        ...
        public static var __parentType: ApolloAPI.ParentType { API.Objects.CalendarDay }
        public static var __selections: [ApolloAPI.Selection] { [
          .field("__typename", String.self),
        ...
        public struct Event: API.SelectionSet {
          ...
          public static var __parentType: ApolloAPI.ParentType { API.Objects.Event }
          public static var __selections: [ApolloAPI.Selection] { [
            .field("__typename", String.self),
        ...
        public struct Entry: API.SelectionSet {
          ...
          public static var __parentType: ApolloAPI.ParentType { API.Interfaces.CalendarEntry }
          public static var __selections: [ApolloAPI.Selection] { [
            .field("__typename", String.self),
