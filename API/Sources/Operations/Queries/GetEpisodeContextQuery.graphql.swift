...
public class GetEpisodeContextQuery: GraphQLQuery {
  public static let operationName: String = "GetEpisodeContext"
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"query GetEpisodeContext($id: ID!, $context: EpisodeContext) { episode(id: $id, context: $context) { __typename context { __typename ... on ContextCollection { items(first: 100) { __typename items { __typename id title description image } } } } } }"#
    ))
  ...
  public struct Data: API.SelectionSet {
    ...
    public struct Episode: API.SelectionSet {
      ...
      public struct Context: API.SelectionSet {
        ...
        public static var __parentType: ApolloAPI.ParentType { API.Unions.EpisodeContextUnion }
        public static var __selections: [ApolloAPI.Selection] { [
          .field("__typename", String.self),
        ...
        public struct AsContextCollection: API.InlineFragment {
          ...
          public static var __parentType: ApolloAPI.ParentType { API.Objects.ContextCollection }
          public static var __selections: [ApolloAPI.Selection] { [
