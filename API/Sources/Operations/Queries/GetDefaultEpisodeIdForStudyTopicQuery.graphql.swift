...
public class GetDefaultEpisodeIdForStudyTopicQuery: GraphQLQuery {
  public static let operationName: String = "GetDefaultEpisodeIdForStudyTopic"
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"query GetDefaultEpisodeIdForStudyTopic($id: ID!) { studyTopic(id: $id) { __typename defaultLesson { __typename defaultEpisode { __typename id } } } }"#
    ))
  ...
  public struct Data: API.SelectionSet {
    ...
    public struct StudyTopic: API.SelectionSet {
      ...
      public static var __parentType: ApolloAPI.ParentType { API.Objects.StudyTopic }
      public static var __selections: [ApolloAPI.Selection] { [
      ...
      public struct DefaultLesson: API.SelectionSet {
        ...
        public static var __parentType: ApolloAPI.ParentType { API.Objects.Lesson }
        public static var __selections: [ApolloAPI.Selection] { [
          .field("__typename", String.self),
